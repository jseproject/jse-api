 ...
 */
public abstract class SoundbankResourceReader {
     ...
     */
    public abstract Soundbank getSoundbank(ClassLoader resourceLoader, String name) throws InvalidMidiDataException, IOException;
