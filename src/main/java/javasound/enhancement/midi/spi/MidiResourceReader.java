package javasound.enhancement.midi.spi;
 ...
 */
public abstract class MidiResourceReader {
     ...
     */
    public abstract MidiFileFormat getMidiFileFormat(ClassLoader resourceLoader, String name) throws InvalidMidiDataException, IOException;
     ...
     * @throws IOException if an I/O exception occurs
     */
    public abstract Sequence getSequence(ClassLoader resourceLoader, String name) throws InvalidMidiDataException, IOException;
