 ...
 */
public abstract class AudioResourceReader {
     ...
     */
    public abstract AudioFileFormat getAudioFileFormat(ClassLoader resourceLoader, String name) throws UnsupportedAudioFileException, IOException;
     ...
     * @throws IOException if an I/O exception occurs
     */
    public abstract AudioInputStream getAudioInputStream(ClassLoader resourceLoader, String name) throws UnsupportedAudioFileException, IOException;
