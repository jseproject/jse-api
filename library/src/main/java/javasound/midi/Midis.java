package javasound.midi;

import javasound.midi.spi.MidiResourceReader;
import javasound.midi.spi.SoundbankResourceReader;
...
public final class Midis {
    ...
    private Midis() {
        throw new AssertionError("No midi.javasound.Midis instances for you!");
    }
